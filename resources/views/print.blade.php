        ...
        <div class="header">
            <table class="header-info">
                <tr>
                    ...
                    <td>{{ \Carbon\Carbon::parse($data['lotteryData']['adddatetime'])->format('d/m/Y h:i') }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    <th width='70%'>numero de billete:</th>
                    <td>{{ $data['lotteryData']['order_id'] }}</td>
                </tr>
            </table>
            <div class="logo">
                <img src="{{asset('assets/images/logo2.webp')}}" alt="image">
            </div>
        </div>
                @php
